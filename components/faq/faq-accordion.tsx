  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      {items.map((item) => {
        ...
        return (
          <div key={item.id} className="border border-gray-200 rounded-lg sm:rounded-xl overflow-hidden hover:border-amber-300 transition-colors">
            <button
            ...
            >
              <h3 className="text-sm sm:text-base font-semibold text-primary flex-1 leading-snug">{question}</h3>
              <svg
