  ...
  const productLinks: FooterLinkItem[] = [
    {
      ...
      label: t_trans.pages.products.title,
    },
  ...
  const resourceLinks: FooterLinkItem[] = [
    {
      ...
      label: t_trans.pages.contact.sendMessage,
    },
    {
      href: `/${lang}/contact#contact-offices`,
      label: t_trans.pages.contact.ourOffices,
    },
        ...
        <div className="container-wide">
            ...
            <div className="flex flex-col justify-between">
              <div className="mb-8">
                <Link
                  ...
                  className={`group mb-4 inline-flex items-center gap-3 ${isRTL ? "flex-row-reverse text-right" : "text-left"}`}
                >
                  <Image
                  ...
                  <span className="flex flex-col leading-none">
                    ...
                    <span
                      className={`mt-1 text-xs font-medium text-white/65 transition-colors duration-300 group-hover:text-accent/80 ${isRTL ? "tracking-normal" : "tracking-[0.24em]"}`}
                    >
                      {brandSecondary}
                    </span>
                  </span>
              ...
              <div className="space-y-4">
                ...
                {footerContactEmail && (
                  <a
                    ...
                    aria-label={
                      lang === "ar"
                        ? `أرسل إلينا على ${footerContactEmail}`
                        : lang === "fa"
                          ? `ایمیل به ${footerContactEmail}`
                          : `Email us at ${footerContactEmail}`
                    }
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <a
                          ...
                          aria-label={
                            lang === "ar"
                              ? `اتصل على ${phone.display}`
                              : lang === "fa"
                                ? `تماس با ${phone.display}`
                                : `Call us at ${phone.display}`
                          }
                ...
                >
                  {t_trans.pages.contact.sendMessage}
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <p className="text-xs text-white/40 leading-relaxed font-light">
              &copy; 2026 Faradid Atlas Foods. {t_trans.footer.copyright} |{" "}
              <span className="text-white/50">ISO 22000</span>
            </p>
