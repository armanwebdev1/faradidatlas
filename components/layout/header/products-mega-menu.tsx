            ...
            <div>
              ...
              <h3
                className={`mt-4 font-hero font-semibold text-foreground ${
                  isRTL
                    ? "max-w-72 text-[1.25rem] leading-[1.35]"
