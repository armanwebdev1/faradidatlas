    ...
    <section className="section relative overflow-hidden bg-surface">
      ...
      <div className="relative z-10 container-wide">
        <div className="grid items-center gap-10 md:gap-12 lg:gap-16 md:grid-cols-2">
          <div
            className={`max-w-md ${isRTL ? "md:order-2 text-right" : "md:order-1 text-left"}`}
          >
            ...
            <h2 className="text-responsive-title text-foreground mb-5 sm:mb-6 text-balance">
              {lang === "en"
                ? "Trusted names, one supplier"
                : "نام‌های آشنا، یک تأمین‌کننده"}
            </h2>
            <p className="text-responsive-body text-foreground/70 text-pretty">
              {lang === "en"
                ? "Mizban, 21, Hayat, and Golbanoo — recognized rice brands delivered through Faradid Atlas."
                : "میزبان، ۲۱، حیات و گلبانو؛ برندهای شناخته‌شده برنج که از طریق فرادید اطلس عرضه می‌شوند."}
            </p>
          </div>
