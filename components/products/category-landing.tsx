...
export function CategoryLanding({
  ...
  const seoTitle =
    getLocalized(categoryData?.seo?.title, lang) || fallbackSeo.title[lang];
  const seoSubtitle =
    getLocalized(categoryData?.seo?.subtitle, lang) ||
    fallbackSeo.subtitle[lang];
  const seoContent =
    getLocalized(categoryData?.seo?.content, lang) || fallbackSeo.content[lang];
