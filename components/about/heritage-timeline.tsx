  ...
  en: [
    {
      year: "1998",
      title: "Foundation",
      description: "Faradi Atlas established with a vision for premium global food trading",
          ...
          <div className="space-y-12 lg:space-y-16">
            {timelineList.map((milestone, idx) => (
              <div key={idx} className="animate-fade-in-up" style={{ animationDelay: `${idx * 0.1}s` }}>
                ...
                >
                  {/* Content */}
                  <div className={`${idx % 2 === 1 ? "lg:text-right lg:order-2" : "lg:order-1"}`}>
                  ...
                  {/* Image */}
                  <div className={`${idx % 2 === 1 ? "lg:order-1" : "lg:order-3"}`}>
