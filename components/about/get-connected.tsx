    ...
    >
      ...
      <div className="w-full px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="relative w-full h-64 md:h-96 rounded-2xl overflow-hidden shadow-2xl animate-fade-in-up">
            <Image
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          {/* Left - Heading */}
          <h2 className="lg:col-span-5 text-4xl md:text-5xl font-bold font-hero text-primary leading-tight tracking-tight animate-fade-in-up">
            {lang === "en"
          ...
          <div dir="ltr" className="lg:col-span-7 space-y-6 text-left">
            <p className="text-base md:text-lg font-semibold text-gray-900 leading-relaxed text-left animate-fade-in-up">
              {lang === "en"
            ...
            <p className="text-sm md:text-base text-gray-700 leading-relaxed text-left animate-fade-in-up">
              {lang === "en"
            ...
            <div className="border-l-2 pl-6 border-accent-warm-gold mt-8 animate-fade-in-up">
