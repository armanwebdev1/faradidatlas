...
const regions = {
  en: [
    ...
    },
    {
      ...
      description:
        "Desert oasis with centuries of unmatched date cultivation expertise",
    },
    {
      name: "Rafsanjan",
      specialty: "Pistachios, Tree Nuts",
      description:
        "World-renowned pistachio region delivering superior quality",
    },
    {
      name: "Various Regions",
      specialty: "Herbs, Spices",
      description:
        "Diverse network ensuring exceptional product variety and consistency",
    },
  ],
  fa: [
    {
    ...
    },
    {
      ...
      description: "شبکه متنوع تضمین کننده تنوع و کیفیت استثنایی محصول",
    },
  ],
};
  ...
  return (
    <>
      ...
      <section className="relative py-0 bg-white overflow-hidden">
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch ${isRTL ? "lg:flex-row-reverse" : ""}`}
        >
          {/* Image Side */}
          <div
            className={`relative h-96 md:h-screen ${isRTL ? "lg:order-2" : ""}`}
          >
            <Image
          ...
          {/* Content Side */}
          <div
            className={`relative flex flex-col justify-center py-16 md:py-24 px-8 sm:px-12 md:px-16 bg-white ${isRTL ? "lg:order-1" : ""}`}
          >
            <div className="max-w-2xl animate-fade-in-up">
              ...
              <h2
                className="text-4xl md:text-5xl font-bold text-primary mb-8 leading-tight tracking-tight font-hero"
              ...
              <div
                className="divider-premium w-16 h-1 mb-10"
                style={{
              ...
              <div className="space-y-8">
                {[
                  {
                    title:
                      lang === "en" ? "Artisanal Excellence" : "برتری صنعتی",
                    desc:
                      lang === "en"
                  ...
                  {
                    title:
                      lang === "en" ? "Transparent Partnerships" : "شرکات شفاف",
                    desc:
                      lang === "en"
                  ...
                  {
                    title:
                      lang === "en" ? "Global Standards" : "استانداردهای جهانی",
                    desc:
                      lang === "en"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-20 animate-fade-in-up">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6 tracking-tight font-hero">
              {lang === "en"
                ? "Strategic Sourcing Regions"
                : "مناطق تأمین استراتژیک"}
            </h2>
