  ...
  en: [
    {
      ...
      description:
        "Rigorous audit and certification of partner farms and facilities",
    },
    {
      number: "02",
      title: "Harvest Monitoring",
      description:
        "Direct oversight during crop collection and initial processing",
    },
    {
      number: "03",
      title: "Lab Testing",
      description:
        "Third-party analysis for pesticides, contaminants, and nutritional content",
    },
    {
      number: "04",
    ...
    },
    {
      ...
      description:
        "Temperature-controlled storage and logistics throughout shipping",
    },
    {
      number: "06",
      title: "Documentation",
      description:
        "Complete certificates of analysis and compliance records provided",
    },
  ],
  fa: [
    {
    ...
    },
    {
      ...
      description:
        "تجزیه‌وتحلیل شخص ثالث برای آفت‌ناشی، آلاینده‌ها و محتوای غذایی",
    },
    {
      number: "۰۴",
