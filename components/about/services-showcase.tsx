  ...
  en: [
    {
      ...
      description:
        "Direct partnerships with the finest producers across Iran and beyond",
    },
    {
      icon: Globe,
      title: "Global Distribution",
      description:
        "Reliable logistics reaching 40+ countries with consistent quality",
    },
    {
      icon: Award,
      title: "Quality Assurance",
      description:
        "Rigorous testing and international certifications at every step",
    },
    {
      icon: Leaf,
      title: "Sustainable Practices",
      description:
        "Ethical sourcing and environmental responsibility in all operations",
    },
    {
      icon: Clock,
      title: "Private Labeling",
      description:
        "Custom white-label solutions tailored to your brand requirements",
    },
    {
      icon: Shield,
      title: "Compliance Support",
      description:
        "Expert guidance on export documentation and regulatory standards",
    },
  ],
  fa: [
    {
    ...
    },
    {
      ...
      title: "برچسب خصوصی",
      description:
        "راه‌حل‌های علامت‌گذاری سفید سفارشی متناسب‌شده برای برند شما",
    },
    {
      icon: Shield,
