...
function resolveMediaUrl(media: any): string {
  ...
  if (typeof media === "object")
    return media.url ?? media.filename ?? "/optimized/featured2.webp";
...
export function CompanyPresence({ lang, companyInfo }: CompanyPresenceProps) {
  ...
  const paragraph1 =
    getLocalized(gc?.paragraph1, lang) ||
    (lang === "en"
      ? "Our company offices are listed in Tehran, Isfahan, Dubai, and Muscat, with operational and storage support in Iran including Shahrekord."
      : lang === "fa"
        ? "فرادید اطلس در تهران، اصفهان، دبی، و مسقظ دفتر دارد و با پشتیبانی عملیاتی و انباری در ایران، از جمله شهرکرد، مسیر تأمین را منظم‌تر و قابل اتکاتر می‌کند."
        : "يوجد لمجموعتنا مكاتب في طهران وأصفهان ودبي و مسقط مع دعم تشغيلي وتخزيني في إيران بما في ذلك شهركرد.");
  const paragraph2 =
    getLocalized(gc?.paragraph2, lang) ||
    (lang === "en"
