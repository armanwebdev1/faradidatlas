...
const features = {
  en: [
    {
      title: "Flexible MOQ",
      description: "Starting from 5,000 kg for most products",
    },
    {
      title: "Custom Packaging",
      description: "Your branding, design, materials of choice",
    },
    {
      title: "Quick Turnaround",
      description: "Production and delivery in 8-12 weeks",
    },
    {
      title: "Compliance Support",
      description: "Help with export documentation and certifications",
    },
  ],
  fa: [
    {
      title: "حداقل سفارش انعطاف‌پذیر",
      description: "شروع از ۵۰۰۰ کیلوگرم برای اکثر محصولات",
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
            {[
              ...
              <div key={idx} className="flex flex-col items-center relative">
                ...
                <p className="text-sm font-medium text-foreground text-center px-2">
                  {step}
                </p>
