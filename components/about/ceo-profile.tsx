...
const content = {
  ...
  ar: {
    ...
    bio: "الدكتور سهراب بختيار، الرئيس التنفيذي لشركة فراديد أطلس، يجمع بين عقود من القيادة التنفيذية وصنع السياسات الاقتصادية وأساس أكاديمي متين في الاقتصاد الدولي والإدارة الاستراتيجية. يُعرف بخبرته في الاستراتيجية Макroeconomic، ولعب أدواراً قيادية في التخطيط الاستراتيجي والقيادة التنظيمية طوال مسيرته المهنية.",
  },
};
