...
export function ApplicationForm({
  ...
  return (
    <form
      ...
      className="bg-white border border-border rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 shadow-md hover:shadow-lg transition-shadow duration-300"
    >
      ...
      <p className="text-gray-700 mb-6 sm:mb-8 text-sm sm:text-base font-medium">
        {jobTitle}
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6 mb-6 md:mb-8">
        ...
        <div>
          ...
          <input
            ...
            required
            placeholder={
              lang === "en" ? "+1 (555) 123-4567" : "+98 (XXX) XXX-XXXX"
            }
            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-border rounded-lg bg-white text-foreground text-sm placeholder:text-gray-400 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all"
          />
        </div>
        ...
        <div>
          ...
          >
            <option value="">
              {lang === "en" ? "Select..." : "انتخاب کنید..."}
            </option>
            <option value="0-2">
              {lang === "en" ? "0-2 years" : "۰-۲ سال"}
            </option>
            <option value="2-5">
              {lang === "en" ? "2-5 years" : "۲-۵ سال"}
            </option>
            <option value="5-10">
              {lang === "en" ? "5-10 years" : "۵-۱۰ سال"}
            </option>
            <option value="10+">
              {lang === "en" ? "10+ years" : "۱۰+ سال"}
            </option>
          </select>
        </div>
      </div>
