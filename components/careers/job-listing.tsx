      ...
      <div className="group relative bg-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 hover:border-amber-300 hover:shadow-xl transition-all duration-500 cursor-pointer overflow-hidden active:scale-98">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-start gap-3 sm:gap-4 md:gap-6 mb-5 sm:mb-6">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm sm:text-base text-amber-700 font-semibold mb-1.5 sm:mb-2">{job.department}</p>
          ...
          <span className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-md sm:rounded-lg text-xs sm:text-sm font-bold whitespace-nowrap shadow-md flex-shrink-0 ${
        ...
        <p className="text-xs sm:text-sm md:text-base text-gray-700 mb-5 sm:mb-6 md:mb-8 leading-relaxed">{description}</p>
