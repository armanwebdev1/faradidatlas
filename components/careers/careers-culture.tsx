...
const cultureItems = {
  ...
  ar: [
    ...
    },
    {
      title: "الاستدامة",
      description:
        "التوريد المسؤول وتقليل الهدر والتعبئة القابلة للتدوير ودعم المجتمع المحلي مهم لنا.",
      icon: Leaf,
    },
    {
      title: "الابتكار",
          ...
          {items.map((item: { icon: any; title: string; description: string }, idx: number) => {
            ...
            return (
              <div
                ...
                className="group rounded-2xl border border-foreground/10 bg-gradient-to-br from-foreground/[0.03] to-transparent p-6 sm:p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-foreground/5"
              >
